    ...
    if (this.state.hasError) {
      ...
      return (
        <main className='flex h-screen w-full flex-col items-center justify-center'>
          ...
          <div className='absolute rotate-12 rounded bg-orangeShopee px-2  text-white'>
            Error!
          </div>
          <button className='mt-5'>
            ...
            >
              <span className='absolute inset-0 translate-x-0.5 translate-y-0.5 bg-orangeShopee transition-transform group-hover:translate-y-0 group-hover:translate-x-0' />
