    ...
    <div className=' bg-[linear-gradient(-180deg,#f53d2d,#f63)] pb-5 pt-2'>
      <div className='md:container'>
        ...
        <div className='mt-4 grid grid-cols-12 items-center gap-4'>
          <Link
            to={path.home}
            className='col-span-3 flex-shrink-0 md:col-span-2'
          >
            <svg
              viewBox='0 0 192 65'
              className='ml-1 h-10  w-full fill-white lg:h-12'
            >
              <g fillRule='evenodd'>
          ...
          <form className='col-span-7 md:col-span-9' onSubmit={onSubmit}>
            <div className='flex w-full rounded-md bg-white p-1'>
              <input
                type='text'
                placeholder='FREESHIP'
                className='w-[75%] flex-grow border-none bg-transparent px-2 py-1 outline-none'
                {...register('name')}
              />
          ...
          <div className='self col-span-2 justify-self-start md:col-span-1'>
            <Popover
